...
class add_variables():
    ...
    def run(self):
        ...
        df2 = (self.df
               ...
               .Define("pTt2", "filtered_tau_pt.size() > 1 ? filtered_tau_pt[1] : -999")
               .Define("etat2", "filtered_tau_eta.size() > 1 ? filtered_tau_eta[1] : -999")
               .Define("phit2", "filtered_tau_phi.size() > 1 ? filtered_tau_phi[1] : -999")
               ...
               .Filter("n_bjets == 2")
               .Filter("n_leptons == 0")
               .Filter("filtered_tau_pt.size() == 2")  # Update filter to use filtered_tau_pt
               .Filter("abs(lepton_eta[0]) < 6")
               .Filter("bjet_pt[0] > 30 && bjet_pt[1] > 30")
               .Filter("filtered_tau_charge[0] != filtered_tau_charge[1]")  # Update filter to use filtered_tau_charge
               .Filter("filtered_tau_pt[0] > 20")
               .Filter("filtered_tau_pt[1] > 20")
